...
class ConnectionManager(Thread):
    ...
    def run(self):
        if not helpers.get_eagle_server_url():
    ...
    def _connect_box(self):
        ...
        req = requests.post('https://iot-proxy.eagle-erp.com/eagle-enterprise/iot/connect-box', json=data, verify=False)
