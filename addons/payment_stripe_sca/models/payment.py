...
from eagle.addons.payment_stripe_sca.controllers.main import StripeControllerSCA as StripeController
from eagle.addons.payment_stripe.models.payment import INT_CURRENCIES
