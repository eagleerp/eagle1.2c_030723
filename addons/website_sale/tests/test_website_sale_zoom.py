...
class TestWebsiteSaleZoom(eagle.tests.HttpCase):
    ...
    def test_01_admin_shop_zoom_tour(self):
        ...
        self.phantom_js("/", "eagle.__DEBUG__.services['web_tour.tour'].run('shop_zoom')", "eagle.__DEBUG__.services['web_tour.tour'].tours.shop_zoom.ready", login="admin")
