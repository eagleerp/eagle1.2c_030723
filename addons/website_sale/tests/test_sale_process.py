...
class TestUi(eagle.tests.HttpCase):
    def test_01_admin_shop_tour(self):
        self.phantom_js("/", "eagle.__DEBUG__.services['web_tour.tour'].run('shop')", "eagle.__DEBUG__.services['web_tour.tour'].tours.shop.ready", login="admin")

    def test_02_admin_checkout(self):
        self.phantom_js("/", "eagle.__DEBUG__.services['web_tour.tour'].run('shop_buy_product')", "eagle.__DEBUG__.services['web_tour.tour'].tours.shop_buy_product.ready", login="admin")

    def test_03_demo_checkout(self):
        self.phantom_js("/", "eagle.__DEBUG__.services['web_tour.tour'].run('shop_buy_product')", "eagle.__DEBUG__.services['web_tour.tour'].tours.shop_buy_product.ready", login="demo")
