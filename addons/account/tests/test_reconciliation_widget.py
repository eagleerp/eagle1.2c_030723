...
class TestUi(eagle.tests.HttpCase):
    ...
    def test_01_admin_bank_statement_reconciliation(self):
        ...
        self.phantom_js("/web#statement_ids=" + str(bank_stmt.id) + "&action=bank_statement_reconciliation_view",
            "eagle.__DEBUG__.services['web_tour.tour'].run('bank_statement_reconciliation')",
            "eagle.__DEBUG__.services['web_tour.tour'].tours.bank_statement_reconciliation.ready", login="admin")
