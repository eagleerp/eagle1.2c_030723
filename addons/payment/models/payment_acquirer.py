...
from eagle.tools import consteq, float_round, image_resize_images, image_resize_image, ustr
...
class PaymentAcquirer(models.Model):
    ...
    EagleERP and the acquirer. It generally consists in return urls given to the
