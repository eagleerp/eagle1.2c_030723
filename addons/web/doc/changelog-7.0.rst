API changes from EagleERP Web 6.1 to 7.0
=======================================

Supported browsers
------------------

The EagleERP Web Client supports the following web browsers:
...
matches the API in EagleERP Web's Python side and in OpenObject addons
...
Renaming
    ...
    database, maybe lazily). EagleERP Web's dataset behaves very
...
API simplification
    ...
    The shortcuts really add little value, and EagleERP Web 6.2 embeds
...
:js:class:`~openerp.web.Model`, EagleERP Web 7.0 removes
