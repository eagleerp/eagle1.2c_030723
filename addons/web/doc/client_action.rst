...
Client actions are the client-side version of EagleERP's "Server
...
In the EagleERP Web code, a client action only requires two pieces of
information:
...
* Providing said object. Two different types of objects can be mapped
  ...
  * An EagleERP Web widget, which must inherit from
