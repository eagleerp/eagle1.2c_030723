eagle.define('web.search_inputs', function (require) {
"use strict";
...
/**
 * Implementation of the ``char`` EagleERP field type:
 *
...
var Filter = Input.extend(/** @lends instance.web.search.Filter# */{
    ...
    /**
     * Implementation of the EagleERP filters (button with a context and/or
