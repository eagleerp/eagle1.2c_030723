...
class AccountMove(models.Model):
    ...
    def _check_hash_integrity(self, company_id):
        ...
        raise UserError(_('''Successful test !
                         ...
                         For this report to be legally meaningful, please download your certification from your customer account on eagle-erp.com (Only for Eagle Enterprise users).'''
                         ) % report_dict)
