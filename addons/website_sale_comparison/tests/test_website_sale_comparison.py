...
class TestUi(eagle.tests.HttpCase):
    ...
    def test_01_admin_tour_product_comparison(self):
        self.phantom_js("/", "eagle.__DEBUG__.services['web_tour.tour'].run('product_comparison')", "eagle.__DEBUG__.services['web_tour.tour'].tours.product_comparison.ready", login='admin')
