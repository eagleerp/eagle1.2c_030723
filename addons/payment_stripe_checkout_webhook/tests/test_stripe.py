...
class StripeTest(StripeCommon):
    ...
    @patch('eagle.addons.payment_stripe_checkout_webhook.models.payment.request')
    @patch('eagle.addons.payment_stripe_checkout_webhook.models.payment.datetime')
    ...
    @patch('eagle.addons.payment_stripe_checkout_webhook.models.payment.requests')
    @patch('eagle.addons.payment_stripe_checkout_webhook.models.payment.request')
    @patch('eagle.addons.payment_stripe_checkout_webhook.models.payment.datetime')
    ...
    def test_handle_checkout_webhook_no_eagle_tx(self):
        stripe_object = stripe_mocks.checkout_session_object
