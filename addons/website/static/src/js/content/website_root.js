...
eagle.define('website.WebsiteRoot', function (require) {
'use strict';
...
require("website.content.zoomeagle");
...
var WebsiteRoot = BodyManager.extend({
    ...
    _multiCompanySwitch: function (ev) {
        ...
        this._rpc({model: 'res.users',
            method: 'write',
            args: [eagle.session_info.user_id, {'company_id': parseInt(company_id_to_switch_to, 10)}],
        }).then(function () {
