...
#VIAddVersionKey "LegalTrademark" "EagleERP is a trademark of ${PUBLISHER}"
...
; English
LangString DESC_EagleERP_Server ${LANG_ENGLISH} "Install the Eagle Server with all the Eagle standard modules."
...
LangString TITLE_EagleERP_Server ${LANG_ENGLISH} "Eagle Server"
LangString TITLE_PostgreSQL ${LANG_ENGLISH} "PostgreSQL Database"
LangString DESC_FinishPageText ${LANG_ENGLISH} "Start Eagle"

; French
LangString DESC_EagleERP_Server ${LANG_FRENCH} "Installation du Serveur Eagle avec tous les modules Eagle standards."
...
LangString TITLE_EagleERP_Server ${LANG_FRENCH} "Serveur Eagle"
...
Section $(TITLE_EagleERP_Server) SectionEagleERP_Server
    SectionIn 1 2
...
# If there is a previous install of the EagleERP Server, keep the login/password from the config file
...
!insertmacro MUI_FUNCTION_DESCRIPTION_BEGIN
    !insertmacro MUI_DESCRIPTION_TEXT ${SectionEagleERP_Server} $(DESC_EagleERP_Server)
...
Function ShowPostgreSQL
    SectionGetFlags ${SectionEagleERP_Server} $0
