...
from eagle.tools import frozendict, classproperty, StackMap, pycompat
...
def constrains(*args):
    ...
    Should raise :class:`~eagle.exceptions.ValidationError` if the
    validation failed.
...
def one(method):
    """ Decorate a record-style method where ``self`` is expected to be a
        ...
        .. deprecated:: 9.0
            ...
            is a single record with :meth:`~eagle.models.Model.ensure_one`.
    """
