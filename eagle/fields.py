...
class Field(MetaField('DummyField', (object,), {})):
    """ The field descriptor contains the field definition, and manages accesses
        ...
        recordset. The decorator :meth:`eagle.api.depends` must be applied on
        ...
        is extended (see :class:`~eagle.models.Model`), one can also extend
...
class Binary(Field):
    ...
    def convert_to_column(self, value, record, values=None, validate=True):
        ...
        # the legacy EagleERP convention is to transfer and store binaries
