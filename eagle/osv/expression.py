...
term representation was ['=', 'company_id.name', 'EagleERP']. Used in a
...
EagleERP will use the SQL function 'unaccent' when available for the
...
Finally, to instruct EagleERP to really use the unaccent function, you have to
