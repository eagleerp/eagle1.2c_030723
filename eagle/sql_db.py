...
"""
The PostgreSQL connector is a connectivity layer between the EagleERP code and
...
class Cursor(object):
    """Represents an open transaction to the PostgreSQL DB backend,
       ...
       ``cursor`` objects.
        ...
        such as EagleERP, we need the best guarantees that no data
        ...
        EagleERP implements its own level of locking protection
        ...
        the default transaction isolation level for EagleERP cursors, as
