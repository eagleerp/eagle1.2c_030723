...
"""
Miscellaneous tools used by EagleERP.
"""
...
def file_open(name, mode="r", subdir='addons', pathinfo=False):
    """Open a file from the EagleERP root, using a subdir folder.
    ...
    if os.path.isabs(name):
        ...
        for root in adps + [rtp]:
            ...
            # It is outside the EagleERP root: skip zipfile lookup.
...
def scan_languages():
    """ Returns all languages supported by EagleERP for translation
...
class UnquoteEvalContext(defaultdict):
    """Defaultdict-based evaluation context that returns
       ...
       the evaluation.
       Mostly useful for evaluating EagleERP domains/contexts that
