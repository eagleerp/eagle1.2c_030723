...
from eagle.tools import pycompat, misc
...
def email_send(email_from, email_to, subject, body, email_cc=None, email_bcc=None, reply_to=False,
    ...
    :deprecate: since EagleERP 6.1, please use ir.mail_server.send_email() instead.
...
def encapsulate_email(old_email, new_email):
    ...
    * New From: notifications@eagle-erp.com
    * Output: "Admin" <notifications@eagle-erp.com>
    """
