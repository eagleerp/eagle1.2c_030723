...
from eagle.tools import partition, pycompat, collections
...
class Users(models.Model):
    """ User class. A res.users record models an EagleERP user and is different
        from an employee.
        ...
        if self._on_login_cooldown(failures, previous):
            ...
            if ipaddress.ip_address(source).is_private:
                _logger.warn(
                    ...
                    "https://www.eagle-erp.com/documentation/12.0/administration/deployment/deploy.html#https for details.",
                    source
                )
