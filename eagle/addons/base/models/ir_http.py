...
from eagle.http import request, STATIC_CACHE, content_disposition
from eagle.tools import pycompat, consteq
...
class IrHttp(models.AbstractModel):
    ...
    def routing_map(cls):
        if not hasattr(cls, '_routing_map'):
            ...
            mods = [''] + eagle.conf.server_wide_modules + sorted(installed)
